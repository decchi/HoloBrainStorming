...
public class UserColorManager : Singleton<UserColorManager>
{
    ...
    void Start () {
        colorMap.Add(0, new Color(1f, 0f, 0f));
        colorMap.Add(1, new Color(1f, 0f, 1f));
        colorMap.Add(2, new Color(0f, 1f, 1f));
        colorMap.Add(3, new Color(0f, 1f, 0f));
        colorMap.Add(4, new Color(1f, 1f, 0f));
        colorMap.Add(5, new Color(1f, 0f, 0f));
        colorMap.Add(6, new Color(0f, 1f, 1f));
